<template>
  <section class="profile-coach">
    <div class="container">
      <div class="wrapper">
        <div class="column-wrapper">
          <div class="profile-block">
            <video
              class="profile-block__video"
            ...
            <div class="profile-block__header">
              <img
                ...
                alt=""
                class="profile-block__header-img"
              />
              <div class="profile-block__header-info">
                <h4 class="profile-block__header-name text-black">
                  Арсений Головин
                </h4>
                <p class="profile-block__header-text text-gray">
                  г. Москва, 30 лет
                </p>
              </div>
            </div>
            <div class="profile-block__static">
              <div class="static__block">
                <h4 class="static__block-number text-black">5.0</h4>
                <div class="static__block-text text-gray">Рейтинг</div>
              </div>
              <div class="static__block">
            ...
            <div class="profile-block__info">
              ...
              <p class="profile-block__info-text text-gray">
                Добрый день! Меня зовут Арсений. У меня большой опыт
                персонального составления плана тренировок и питания,
                составление программ тренировки и питаниядистанционно (стаж с
                2010 года), подготовка профессиональных атлетов к спортивному
                сезону(баскетбол, хоккей, регби, многоборье, силовые виды).
              </p>
              <a href="" class="profile-block__info-button">Редактировать</a>
            </div>
            <div class="profile-block__accept">
              <div class="profile-block__accept-header">
                <h4 class="profile-block__accept-text">
                  Готовность к пробным урокам
                </h4>
              </div>
              <button class="button profile-block__accept-button">
                Повысить статус
              </button>
            </div>
          </div>
            ...
            <div class="review__block" v-for="item in 15" :key="item">
              <router-link :to="{name: 'Profile User'}"
                ><img
                  src="../assets/img/coach-modal-img.png"
                  alt=""
                  class="review__block-img"
              /></router-link>
              <div class="review__block-content">
                <router-link
                  class="review__block-name"
